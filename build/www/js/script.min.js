...
class MSWindow {
  constructor(title, html, x, y, width, height, buttons) {
    ...
    this.header.style.borderBottom = "1px solid #000";
    ...
    this.closeButton.onclick = () => this.kill();
                        ...
                        return {
                            items: {
                                ...
                                stats: {
                                    name: "Get Stats",
                                    callback: function () {
                                        new MSWindow(`${d.userPublic.name}'s Stats`, `Name: ${d.userPublic.name} </br> Color: ${d.userPublic.color}`, 100, 100, 300, 200, ["Ok"]);
                                    },
                                },
                            },
                        };
